 ...
 * <li> The file <code>java-gmail-imap.mailcap</code> in the user's home directory.
 * <li> The file &lt;<i>java.home</i>&gt;<code>/lib/.java-gmail-imap.mailcap</code>.
 * <li> The file or resources named <code>META-INF/java-gmail-imap.mailcap</code>.
 * <li> The file or resource named <code>META-INF/java-gmail-imap.mailcap.default</code>
...
public class MailcapCommandMap extends CommandMap {
	...
	try {
	    ...
	    if (user_home != null) {
		String path = user_home + File.separator + ".java-gmail-imap.mailcap";
		mf = loadFile(path);
		if (mf != null)
		    dbv.add(mf);
	    }
	...
	try {
		...
		File.separator + "lib" + File.separator + "java-gmail-imap.mailcap";
	...
	loadAllResources(dbv, "META-INF/java-gmail-imap.mailcap");

	LogSupport.log("MailcapCommandMap: load DEF");
	synchronized (MailcapCommandMap.class) {
	    // see if another instance has created this yet.
	    if (defDB == null)
		defDB = loadResource("/META-INF/java-gmail-imap.mailcap.default");
	}
