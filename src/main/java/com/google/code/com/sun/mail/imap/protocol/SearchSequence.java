...
import com.google.code.javax.mail.search.AddressTerm;
...
import com.google.code.javax.mail.search.DateTerm;
...
import com.google.code.javax.mail.search.GmailSearchTerm;
import com.google.code.javax.mail.search.HeaderTerm;
import com.google.code.javax.mail.search.MessageIDTerm;
import com.google.code.javax.mail.search.NotTerm;
import com.google.code.javax.mail.search.OrTerm;
import com.google.code.javax.mail.search.ReceivedDateTerm;
import com.google.code.javax.mail.search.RecipientStringTerm;
import com.google.code.javax.mail.search.RecipientTerm;
...
import com.google.code.javax.mail.search.StringTerm;
...
public class SearchSequence {
	...
	if (term instanceof AndTerm) 		// AND
        ...
        else if (term instanceof GmailSearchTerm) // Gmail Search Term
            return gmailsearchterm((GmailSearchTerm)term, charset);
	else
    ...
    private static Argument gmailsearchterm(GmailSearchTerm term, String charset) throws UnsupportedEncodingException {
	Argument result = new Argument();
	result.writeAtom(term.getSearchAttribute());
	// XXX confirm that charset conversion ought to be done
	result.writeString(term.getPattern(), charset); 
	return result;
    }
